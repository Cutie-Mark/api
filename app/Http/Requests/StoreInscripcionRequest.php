...
class StoreInscripcionRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'nombres.regex'                            => 'El campo nombres no debe contener números',
            'apellidos.regex'                          => 'El campo apellidos no debe contener números',
            'ci.regex'                                 => 'El CI debe tener 8 dígitos, seguido opcionalmente de un guión y el complemento (ej: 12345678-1A)',
            'ci.max'                                   => 'CI no debe tener más de 11 caracteres',
            ...
            'codigo_lista.required'                    => 'Código de lista vacío',
